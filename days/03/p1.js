    ...
    for(n in dic[l]){
        dic[l][n].map(i => {
           ...
           for(n2 in dic[Number(l)]){
                    if(!Number(n2)){
                        if(!boo) {
                            boo = dic[Number(l)][n2].includes(number)
                        }
                    }
                }
            })
        for(len in n) arr.push(Number(len)+i)
        arr.map(number => {
            if(l !== 0 && !boo) for(n2 in dic[Number(l)-1]){
                    if(!Number(n2)){
                        if(!boo) {
                            boo = dic[Number(l)-1][n2].includes(number)
                        }
                    }
                }
            if(l !== 0 &&  Object.keys(l).length) for(n2 in dic[Number(l)+1]){
                    if(!Number(n2)){
                        if(!boo) {
                            boo = dic[Number(l)+1][n2].includes(number)
                        }
            ...
            boo && validNumbers.push(Number(n))
        })
    }
}
let sum = 0
